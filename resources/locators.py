...
class SearchPageLocators:
    ...
    search_result = (By.CLASS_NAME, "Organic-Subtitle")
    images_link = (By.CSS_SELECTOR, "a[data-id='images']")


class ResultPageLocators:
    expected_link = (By.PARTIAL_LINK_TEXT, "tensor.ru")
...
class ImagesResultPageLocators:
    input_field = (By.CLASS_NAME, "mini-suggest__input")
    image = (By.CLASS_NAME, 'serp-item_pos_0')
    next_button = (By.CLASS_NAME, 'CircleButton_type_next')
    back_button = (By.CLASS_NAME, 'CircleButton_type_prev')
    main_image = (By.CLASS_NAME, 'MMImage-Origin')
